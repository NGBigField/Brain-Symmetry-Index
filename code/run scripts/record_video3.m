...
Constants.delta_freq =     1;  % Brain Assymetry frequency resolution:
Constants.BAsy_freqs = Classes.BrainWavesFreqs.Beta.freqs;  % freqs to indclude in BAsy clac
Constants.BAsy_imfs  = [2,3]; % imfs to indclude in BAsy clac
...
printedProgBar = Classes.PrintedProgressBar(nData, mark="X", msg="Overall Progress:");
for iData = 1 : nData
    %% Step:
    printedProgBar.step();
