%{
Sasikanth (2022). Bi dimensional Emperical Mode Decomposition (BEMD) 
...
function [ imf_tensor, residue ] = bemd( input_image, options )
    ...
    % Make a 'double' version of the image:
    ...
    % Expected Errors at last imf:
    expected_errors_at_last_imf = [
